...
def choosing():
    ...
    if enter=='Список':
        ...
        if enter=='1':
            print('Поместите файл с фотографией в папку i и введите название файла с расширением')
            tonirovka()
            save()
        elif enter=='2':
            print('Поместите файл с фотографией в папку i и введите название файла с расширением')
...
def save():
    global way
    print('Вы хотите сохранить фотографию в папку i взамен предыдущей? (да, нет)')
    yes_no=input().lower()
    if yes_no=='да':
        img.save(way, format='PNG')
    elif yes_no=='нет':
        print('Ок')
    else:
        print('Некорректное значение')
